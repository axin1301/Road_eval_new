...
def mapcompare_d500_first_update_new(fgt,fd,fr,county,radius):
    ...
    df.to_csv('../output/'+county+'_'+str(i)+'_test.csv', index=False)
...
def main():
    ...
    for county in ['130634', '411523', '130530', '130631', '469001', '130636', '130529', '341203', '130532', '130531', '130434', '620102', '469024', '130925', '360781', '610426', '130924', '131124', '620802', '130425', '130533', '131128', '411625', '130125', '520328', '130522', '140829', '410328', '341322', '130927', '610826', '451022', '610430']:
    ...
    # ['130631', '131123', '131122', '141034', '130925', '131128', '341203', '131124', '130434', '522635']:#['610328', '130533', '130529', '130532', '130531'][:2]:#['130522']:#['610328', '130533', '130529', '130532', '130531', '130631', '131123', '131122', '141034', '130925', '131128', '341203', '131124', '130434', '522635']:#['130522']:#district_list:
        print(county)
        if os.path.exists('../output/'+county+'_'+str(0.001)+'_test.csv'):
            continue
